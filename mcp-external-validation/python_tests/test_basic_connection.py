...
async def test_basic_connection(server_url: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        issues.append({
            ...
            "category": "connection",
            "description": str(e),
            "stack_trace": traceback.format_exc() if 'traceback' in globals() else None
        })
    ...
    return {
        ...
        "results": results,
        "error": None if results["errors_encountered"] == 0 else "Connection test failed",
        "issues": issues,
        "compatibility": {
