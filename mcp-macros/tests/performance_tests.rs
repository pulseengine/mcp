...
mod tests {
    ...
    async fn test_resource_performance() {
        ...
        let fast_result = server
            .performance_resource("fast".to_string(), "123".to_string())
            .await;
        ...
        let start = Instant::now();
        let slow_result = server
            .performance_resource("slow".to_string(), "456".to_string())
            .await;
        ...
        let start = Instant::now();
        let cached_result = server
            .performance_resource("cached".to_string(), "key_5".to_string())
            .await;
    ...
    async fn test_concurrent_mixed_operations() {
        ...
        let resource_task =
            server.performance_resource("fast".to_string(), "concurrent".to_string());
        ...
        for i in 0..200 {
            ...
            handles.push(tokio::spawn(async move {
                match i % 4 {
                    ...
                    1 => server_clone
                        .performance_resource("fast".to_string(), format!("id_{}", i))
                        .await
                        .unwrap_or_else(|_| "error".to_string()),
                    2 => server_clone
                        .concurrent_data_access(format!("key_{}", i % 100))
                        .await
