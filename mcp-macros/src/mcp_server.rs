...
fn generate_server_implementation(
    ...
    Ok(quote! {
        ...
        // Default trait for tool discovery - provides empty implementations
        trait McpToolsDefault {
        ...
        // Blanket implementation for all types - can be overridden by #[mcp_tools]
        impl<T> McpToolsDefault for T {}
        ...
        impl #impl_generics #struct_name #ty_generics #where_clause {
            ...
            fn get_automatic_tools(&self) -> Vec<pulseengine_mcp_protocol::Tool> {
                // Call the method - either default (empty) or overridden by #[mcp_tools]
                <Self as McpToolsDefault>::__mcp_get_discovered_tools(self)
            }
            ...
            async fn dispatch_automatic_tool(
                ...
                // Call the method - either default (None) or overridden by #[mcp_tools]
                <Self as McpToolsDefault>::__mcp_dispatch_discovered_tool(self, request).await
            }
